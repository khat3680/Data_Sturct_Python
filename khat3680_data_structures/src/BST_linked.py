...
class _BST_Node:
    ...
    def __init__(self, value):
        """
        -------------------------------------------------------
        Initializes a BST node containing value. Chisld pointers 
...
class BST:
    ...
    def _remove_aux(self, node, key):
        ...
        if node is None:
            # Base Case: the key is no in the tree.
            value = None
    ...
    def __contains__(self, key):
        ...
        return not self.retrieve(key) == None
    ...
    def is_identical_aux(self,node,node2):
        if node is None and node2 is None:
            ...
            identical = self.is_identical_aux(node._left, node2._left) and self.is_identical_aux(node._right, node2._right)
    ...
    def parent_r(self, key):
        ...
        def parent_r_aux(self,node,key,parent):
            ...
            # General Case: Search the right subtree.    
                ...
                self.parent_r_aux(node._right,key,node)
    ...
    def max(self):
        ...
        value = deepcopy(self._root._value) 
    ...
    def max_r(self):
        ...
        elif self._root._right is not None:
            value = self.max_r(self._root._right)
    ...
    def _is_valid_aux(self, node):
        ...
        elif node._left is not None and node._left._value <= node._value or node.r_count > node._left.r:
    ...
    def update(self, value, update):
        ...
        while node is not None and value != node._value:
        ...
        elif node is None and value != node._value:
            updated = False
            self.insert(value)
